...
class Sun extends Component<IProps> {
    render() {
        return (
            <svg style={this.props.style} className={this.props.className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black">
