...
// create a provider
// Only thing missing is login with popup - don't need that, want to redirect!
export class Auth0Provider extends Component<{}, IState> {
    ...
    // TODO: Can load that with .env file?
    ...
    handleRedirectCallback = async () => {
        ...
        const user = await this.state.auth0Client.getUser(); // ADDITIONAL - getting a user
